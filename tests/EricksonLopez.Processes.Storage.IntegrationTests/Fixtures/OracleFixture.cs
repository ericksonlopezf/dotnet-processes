...
{
    private readonly OracleContainer _oracle = new OracleBuilder("gvenzl/oracle-free:23-slim-faststart")
        .Build();
    ...
    public async Task InitializeAsync()
    {
        ...
        const string ddl = """
            BEGIN
                ...
                EXECUTE IMMEDIATE 'CREATE UNIQUE INDEX IX_PROC_INST_CORR ON PROCESS_INSTANCES(CORRELATION_ID)';
            EXCEPTION
                WHEN OTHERS THEN
                    IF SQLCODE != -955 THEN
                        RAISE;
