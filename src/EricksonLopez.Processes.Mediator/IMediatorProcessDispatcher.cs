...
/// <summary>
/// Defines a contract for dispatching process effects directly through an in-memory mediator.
/// </summary>
public interface IMediatorProcessDispatcher
{
    /// <summary>
    /// Dispatches a batch of process effects through the mediator.
    /// </summary>
    ...
    /// <summary>
    /// Dispatches a single process effect through the mediator.
    /// </summary>
