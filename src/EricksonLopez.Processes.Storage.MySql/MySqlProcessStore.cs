...
/// <summary>
/// Provides a MySQL implementation of <see cref="IProcessStore{TState}"/> using raw parameterized MySqlConnector commands and JSON payloads.
/// </summary>
...
public sealed partial class MySqlProcessStore<TState> : IProcessStore<TState>
    where TState : notnull
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="MySqlProcessStore{TState}"/> class with the specified connection string and serializer.
    /// </summary>
