...
/// <summary>
/// Specifies that a class is a process manager definition discovered for compile-time registration.
/// </summary>
[AttributeUsage(AttributeTargets.Class, Inherited = false, AllowMultiple = false)]
public sealed class ProcessDefinitionAttribute : Attribute
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ProcessDefinitionAttribute"/> class with the specified process type and version.
    /// </summary>
    ...
    public ProcessDefinitionAttribute(string processType, int version = 1)
    {
