    ...
    where TState : notnull
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        while (true)
        {
            ...
            var (instance, isNew, shouldExitEarly) = await ResolveInstanceAsync(
    ...
    private async ValueTask<(ProcessInstance<TState> Instance, bool IsNew, bool ShouldExitEarly)> ResolveInstanceAsync<TEvent>(
        ProcessId processId,
        CorrelationId correlationId,
        IProcessHandler<TState, TEvent> handler,
        TEvent eventMessage,
        ...
        where TSaga : IProcess<TState>, ICompensationHandler<TState>
    {
        ...
        var recordedSteps = instance.RecordedCompensations ?? [];
        return await CompensateAsync(processId, recordedSteps, saga, cancellationToken);
    }
